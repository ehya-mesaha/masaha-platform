...
import { StepProps, RuleItem, DEFAULT_RULES } from './types'
...
const POLICIES = [
  {
    value: 'FLEXIBLE',
    label: 'مرنة',
    desc: 'استرداد كامل للمبلغ عند الإلغاء قبل موعد الحجز بـ24 ساعة.',
  },
  {
    value: 'MODERATE',
    label: 'متوسطة',
    desc: 'استرداد 50% من مبلغ الحجز عند الإلغاء قبل الموعد بـ5 أيام.',
  },
  {
    value: 'STRICT',
    label: 'صارمة',
    desc: 'لا يُسترد أي مبلغ عند إلغاء الحجز.',
  },
]
        ...
        <div className="space-y-2 mb-4">
          {form.rules.map((r, i) => (
            <div key={i} className="flex items-center gap-3 p-3 rounded-xl border border-[#D8D1C7] bg-white">
              ...
              {!(DEFAULT_RULES as readonly string[]).includes(r.rule) && (
