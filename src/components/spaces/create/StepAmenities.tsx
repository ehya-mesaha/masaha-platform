  ...
  return (
    <div>
      ...
      {techAmenities.length > 0 && (
        <div className="mb-6">
          <h3 className="text-sm font-bold text-[#1B1B1B] mb-3">التجهيزات التقنية والعرض</h3>
      ...
      {comfortAmenities.length > 0 && (
        <div className="mb-6">
          <h3 className="text-sm font-bold text-[#1B1B1B] mb-3">الراحة والخدمات الأساسية</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
      ...
      {otherAmenities.length > 0 && (
        <div>
          <h3 className="text-sm font-bold text-[#1B1B1B] mb-3">أخرى</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
