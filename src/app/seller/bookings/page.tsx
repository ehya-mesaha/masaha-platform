    ...
    <div className="dashboard-page">
      <div className="page-hero mb-6 p-6 animate-in">
        <div className="relative">
          <p className="text-xs font-bold text-[#C49A3C] mb-2">إدارة الحجوزات</p>
      ...
      {bookings.length === 0 ? (
        <Card>
          <div className="text-center py-12 text-gray-500">
            <svg className="mx-auto mb-4 h-10 w-10 text-[#1B3A2D]" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path d="M8 3v3m8-3v3M4 9h16M5 5h14a1 1 0 0 1 1 1v14H4V6a1 1 0 0 1 1-1Z" /></svg>
